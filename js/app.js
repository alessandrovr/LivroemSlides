  ...
  function renderHome() {
    ...
    root.innerHTML = `
      <header class="hero">
        ...
        <p class="hero__subtitle">Descubra se seu nível técnico já está à altura da sua faixa.</p>
        <p class="book-banner">📘 Este app é parte integrante do livro “De Branca a Preta”, de Alessandro Vieira dos Reis, e apresenta apenas uma parte do conteúdo do livro.</p>
      </header>
